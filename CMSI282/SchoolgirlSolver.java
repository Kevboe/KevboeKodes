...
public class SchoolgirlSolver {
  ...
  public void fillAdjMatrix( int currentGirl, int previousGirl ) {
    adjMatrix[currentGirl][previousGirl] = false;
    adjMatrix[previousGirl][currentGirl] = false;
  ...
  public int[][] solver( int currentGirl, int y, int x ){
    ...
    if( x < 15){
      ...
      if( this.canPlace( currentGirl, y, x) ){
        ...
        this.fillAdjMatrix(currentGirl, girlGroups[y][x - 1]);
        if(numOfRuns == 2){
          return girlGroups;
        }
