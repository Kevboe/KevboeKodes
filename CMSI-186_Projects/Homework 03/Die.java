...
public class Die {
   ...
   */
   public Die( int nSides ) {
     if(nSides < MINIMUM_SIDES){
       throw new IllegalArgumentException("The die must have atleast 4 sides.");
     }
     this.sides = nSides;
     this.dieRoll = 1;
   }
   ...
   * @throws      IllegalArgumentException
   */
   public int setValue( int sides ) {
     if( sides < MINIMUM_SIDES){
       throw new IllegalArgumentException("Die Must have atleast 4 sides.");
     }
     this.sides = sides;
     return sides;
   }
   ...
   */
   public static void main( String[] args ) {
      ...
      try{
        ...
        System.out.println("A die must have aleast 4 sides.");
      }
   }
